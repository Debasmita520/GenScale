...
n=length(y)
  ...
  LL4=function(thetta,x,y,I){
    ...
    x1=optim(xstart,LL1,x=x,y=y,I=p11)$par[1]
    x2=optim(xstart,LL1,x=x,y=y,I=p11)$par[2]
    x3=optim(xstart,LL1,x=x,y=y,I=p11)$par[3]
    x4=optim(xstart,LL2,x=x,y=y,I=p11)$par[1]
    x5=optim(xstart,LL2,x=x,y=y,I=p11)$par[2]
    x6=optim(xstart,LL2,x=x,y=y,I=p11)$par[3]
    y1=optim(xstart,LL3,x=x,y=y,I=p11)$par[1]
    y2=optim(xstart,LL3,x=x,y=y,I=p11)$par[2]
    y3=optim(xstart,LL3,x=x,y=y,I=p11)$par[3]
    y4=optim(xstart,LL4,x=x,y=y,I=p11)$par[1]
    y5=optim(xstart,LL4,x=x,y=y,I=p11)$par[2]
    y6=optim(xstart,LL4,x=x,y=y,I=p11)$par[3]
    
    #.............................TK approximation
    
    H=-LL2(c(x4,x5,x6),x=x,y=y,I=p11)+LL1(c(x1,x2,x3),x=x,y=y,I=p11)
    
    I=-LL3(c(y1,y2,y3),x=x,y=y,I=p11)+LL1(c(x1,x2,x3),x=x,y=y,I=p11)
    
    J=-LL4(c(y4,y5,y6),x=x,y=y,I=p11)+LL1(c(x1,x2,x3),x=x,y=y,I=p11)
    
    
    MLtko=optim(c(x1,x2,x3),LL1,x=x,y=y,I=p11)$par
    Ho=optim(c(x1,x2,x3),LL1,x=x,y=y,I=p11,hessian = TRUE)$hessian
    MLtkalpha1=optim(c(x4,x5,x6),LL2,x=x,y=y,I=p11)$par
    Halpha1=optim(c(x4,x5,x6),LL2,x=x,y=y,I=p11,hessian = TRUE)$hessian
    MLtkalpha2=optim(c(y1,y2,y3),LL3,x=x,y=y,I=p11)$par
    Halpha2=optim(c(y1,y2,y3),LL3,x=x,y=y,I=p11,hessian = TRUE)$hessian
    MLtklambda=optim(c(y4,y5,y6),LL4,x=x,y=y,I=p11)$par
    Hlambda=optim(c(y4,y5,y6),LL4,x=x,y=y,I=p11,hessian = TRUE)$hessian
    sigma0=det(solve(Ho))
