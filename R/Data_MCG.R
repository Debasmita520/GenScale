...
MCMC=function(alpha1int,alpha2int,lamdaint,sd1,sd2,sd3,X1,X2,n1,n2,a,b,c,d,p,q,N){
  alpha1mc=array(0,N)
...
n2=length(x2)
  ...
  mcmc=MCMC(alpha1int=1.84,alpha2int=1.68,lamdaint=0.004,sd1=0.3,sd2=0.3,sd3=0.3,X1=x1,X2=x2,n1=n1,n2=n2,a=a,b=b,c=c,d=d,p=p,q=q,N=N)
