...
MCMC=function(alpha1int,alpha2int,lamdaint,sd1,sd2,sd3,X1,X2,alpha1,alpha2,lamda,n1,n2,a,b,c,d,p,q,N){
  alpha1mc=array(0,N)
  ...
  for (i in 2:N) {
    ...
    p11=dgamma(alpha1str,a,b)
    p12=dgamma(alpha1int,a,b)
    p21=dgamma(alpha2str,c,d)
    p22=dgamma(alpha2int,c,d)
    p31=dgamma(lamdastr,p,q)
    p32=dgamma(lamdaint,p,q)
...
for (j in 1:M) {
  ...
  mcmc=MCMC(alpha1int=alpha1,alpha2int=alpha2,lamdaint=lamda,sd1=0.3,sd2=0.3,sd3=0.3,X1=x1[,j],X2=x2[,j],alpha1=alpha1,alpha2=alpha2,lamda=lamda,n1=n1,n2=n2,a=a,b=b,c=c,d=d,p=p,q=q,N=N)
