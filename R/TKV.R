...
for (j in 1:M) 
{
  ...
  x1[j]=optim(xstart,LL1,x=x[,j],y=y[,j],c=c)$par[1]
  x2[j]=optim(xstart,LL1,x=x[,j],y=y[,j],c=c)$par[2]
  x3[j]=optim(xstart,LL1,x=x[,j],y=y[,j],c=c)$par[3]
  x4[j]=optim(xstart,LL2,x=x[,j],y=y[,j],c=c)$par[1]
  x5[j]=optim(xstart,LL2,x=x[,j],y=y[,j],c=c)$par[2]
  x6[j]=optim(xstart,LL2,x=x[,j],y=y[,j],c=c)$par[3]
  y1[j]=optim(xstart,LL3,x=x[,j],y=y[,j],c=c)$par[1]
  y2[j]=optim(xstart,LL3,x=x[,j],y=y[,j],c=c)$par[2]
  y3[j]=optim(xstart,LL3,x=x[,j],y=y[,j],c=c)$par[3]
  y4[j]=optim(xstart,LL4,x=x[,j],y=y[,j],c=c)$par[1]
  y5[j]=optim(xstart,LL4,x=x[,j],y=y[,j],c=c)$par[2]
  y6[j]=optim(xstart,LL4,x=x[,j],y=y[,j],c=c)$par[3]
  ...
  #.............................TK approximation
  H[j]=-LL2(c(x4[j],x5[j],x6[j]),x=x[,j],y=y[,j],c=c)+LL1(c(x1[j],x2[j],x3[j]),x=x[,j],y=y[,j],c=c)
  
  I[j]=-LL3(c(y1[j],y2[j],y3[j]),x=x[,j],y=y[,j],c=c)+LL1(c(x1[j],x2[j],x3[j]),x=x[,j],y=y[,j],c=c)
  
  J[j]=-LL4(c(y4[j],y5[j],y6[j]),x=x[,j],y=y[,j],c=c)+LL1(c(x1[j],x2[j],x3[j]),x=x[,j],y=y[,j],c=c)
  
  
  MLtko[,j]=optim(c(x1[j],x2[j],x3[j]),LL1,x=x[,j],y=y[,j],c=c)$par
  Ho=optim(c(x1[j],x2[j],x3[j]),LL1,x=x[,j],y=y[,j],c=c,hessian = TRUE)$hessian
  MLtkalpha1[,j]=optim(c(x4[j],x5[j],x6[j]),LL2,x=x[,j],y=y[,j],c=c)$par
  Halpha1=optim(c(x4[j],x5[j],x6[j]),LL2,x=x[,j],y=y[,j],c=c,hessian = TRUE)$hessian
  MLtkalpha2[,j]=optim(c(y1[j],y2[j],y3[j]),LL3,x=x[,j],y=y[,j],c=c)$par
  Halpha2=optim(c(y1[j],y2[j],y3[j]),LL3,x=x[,j],y=y[,j],c=c,hessian = TRUE)$hessian
  MLtklambda[,j]=optim(c(y4[j],y5[j],y6[j]),LL4,x=x[,j],y=y[,j],c=c)$par
  Hlambda=optim(c(y4[j],y5[j],y6[j]),LL4,x=x[,j],y=y[,j],c=c,hessian = TRUE)$hessian
